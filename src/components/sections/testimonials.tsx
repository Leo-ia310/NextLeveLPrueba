...
const Testimonials = () => {
  ...
  return (
    <section 
      id="testimonials" 
      className="bg-[#052552] text-white"
      ref={ref}
    >
      <div className={`mx-auto max-w-7xl px-4 py-16 sm:py-20 md:px-6 lg:py-28 transition-all duration-[1500ms] ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="mb-8 sm:mb-10 lg:mb-12">
          <h2 id="clientes-title" className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">
          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial) => (
                ...
                >
                  <div className="mx-auto max-w-3xl rounded-2xl border border-[#009299]/30 bg-[#041b45]/60 p-6 sm:p-8 backdrop-blur-sm">
